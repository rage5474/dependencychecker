...
/**
 * This is the item provider adapter for a {@link de.raphaelgeissler.dependencychecker.ComponentDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentDescriptionItemProvider 
	 ...
	 * @generated
	 */
	public ComponentDescriptionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentDescription_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentDescription_name_feature", "_UI_ComponentDescription_type"),
				 DependencycheckerPackage.Literals.COMPONENT_DESCRIPTION__NAME,
				 true,
				 false,
				 false,
	 ...
	 * @generated
	 */
	protected void addComponentItemsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentDescription_componentItems_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentDescription_componentItems_feature", "_UI_ComponentDescription_type"),
	...
	/**
	 * This returns ComponentDescription.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComponentDescription"));
	}
	...
	public String getText(Object object) {
		String label = ((ComponentDescription)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ComponentDescription_type") :
			getString("_UI_ComponentDescription_type") + " " + label;
	}
