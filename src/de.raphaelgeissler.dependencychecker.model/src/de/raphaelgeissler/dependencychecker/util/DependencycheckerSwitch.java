 ...
 * @generated
 */
public class DependencycheckerSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public DependencycheckerSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DependencycheckerPackage.CHECKER: {
				Checker checker = (Checker)theEObject;
				T result = caseChecker(checker);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DependencycheckerPackage.COMPONENT_DESCRIPTION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Component Item Description</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Component Item Description</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComponentItemDescription(ComponentItemDescription object) {
		return null;
	}
